...
module DataServer {
    ...
    function updateUsingNewProtocol(responseCode as Lang.Number, data as Lang.Array?) as Void {
        if (responseCode == 200) {
    ...
    function updateUsingOldProtocol_main(responseCode as Lang.Number, data as Null or Lang.Dictionary) as Void {
        if (responseCode == 200) {
